...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $errors[] = 'Unable to create the award record.';
...
<head>
    ...
    <title>Add Award | Jutsue Portfolio CMS</title>
...
<main class="container">
    ...
    <div class="page-header">
        ...
        <h1>Add Award & Recognition</h1>

        <p>
            Add a professional award, honor, or recognition.
        </p>
