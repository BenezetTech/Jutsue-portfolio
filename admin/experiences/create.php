 ...
 *
 * Authenticated administrators can create experience records.
 */
    ...
    if ($jobTitle === '') {
        ...
        try {
            ...
            */
            ...
            error_log(
                'Experience creation error: ' . $e->getMessage()
            );

            $error =
                'Unable to create the professional experience record.';
        }
    }
}
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="text-muted mb-4">
                        Add a position to the professional career timeline.
                    </p>
                    ...
                    <form method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder="IT Director & Head of Digital Operations"
                                    required
                                >
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                Lower numbers appear first in the CMS list.
                            </div>
